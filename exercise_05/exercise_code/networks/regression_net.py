...
class RegressionNet(Network):
    ...
    def forward(self, X):
        ...
        ########################################################################
        y, cache_affine1 = affine_forward(X, W1, b1)
        y, cache_sigmoid = sigmoid_forward(y)
        y, cache_affine2 = affine_forward(y, W2, b2)
        ########################################################################
        #                           END OF YOUR CODE                           #
        ########################################################################
    ...
    def backward(self, dy):
        ...
        ########################################################################
        dy2, dW2, db2 = affine_backward(dy, cache_affine2)
        dy1 = sigmoid_backward(dy2, cache_sigmoid)
        dX, dW1, db1 = affine_backward(dy1, cache_affine1)
        ########################################################################
        #                           END OF YOUR CODE                           #
        ########################################################################
